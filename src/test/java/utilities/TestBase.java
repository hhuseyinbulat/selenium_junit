...
public abstract class TestBase {
    ...
    public static List<String> windowsHandle = new ArrayList<>();
    ...
    public void setup() {
        ...
        extentReports.setSystemInfo("Tester","Hüseyin");
    ...
    public static void switchToWindow(int windowNumber) {
        driver.switchTo().window(windowsHandle.get(windowNumber - 1));
    }
...
*/
    ...
    //Driver get and take handle
    public static void driverGet(String url) {
        driver.get(url);
        windowsHandle.add(driver.getWindowHandle());
    }
...
//        path
    ...
    //Elemente yazı gönderme
    public  void typeWithJS(WebElement webElement, String text){
        JavascriptExecutor js = (JavascriptExecutor) driver;
        js.executeScript("arguments[0].setAttribute('value', '"+text+"')",webElement);
    }
    //input elemntindeki değeri alma
