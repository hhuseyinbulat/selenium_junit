...
//        tumVeriler.forEach(t-> System.out.println(t.getText()));//LAMDA
    ...
    public void printTableData(int row,int coloumn){
        String tableData =driver.findElement(By.xpath("//table//tbody//tr["+row+"]//td["+coloumn+"]")).getText();
        System.out.println(row+". Satır, "+coloumn+". Sütun Elemanı: "+tableData);
